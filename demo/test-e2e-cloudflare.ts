/**
 * Test end-to-end con Cloudflare Workers AI.
 * Verifica que el flujo completo funciona con embeddinggemma-300m via Cloudflare.
 *
 * Uso: bun demo/test-e2e-cloudflare.ts
 */
...
async function main() {
  console.log('=== Agent Shell E2E Test (Cloudflare Workers AI) ===\n');

  // Bootstrap
  const embeddingAdapter = new CloudflareEmbeddingAdapter({
